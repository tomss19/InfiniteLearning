 ...
 */
fun myName(): String {
    val group = arrayOf("tomi,lumban,zain,mona,siti")
    return "tomi,lumban,zain,mona,siti"
}
...
fun main() {
     ...
     *
     */
    groupDetail(1, listOf("tomi", "lumbabn", "zain","siti","mona"), "afternoon")
